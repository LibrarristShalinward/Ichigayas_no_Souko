...
def div_stateI(keys, simos): 
    ...
    div_result_reporter(keys, "指法分析阶段一进度：")
...
def div_stateII(keys): 
    ...
    div_result_reporter(keys, "指法分析阶段二进度：")
    return div_result_wrapper(keys)
...
def div_stateIV(keys): 
    ...
    div_result_reporter(keys, "指法分析阶段四进度：")
    return div_result_wrapper(keys)
